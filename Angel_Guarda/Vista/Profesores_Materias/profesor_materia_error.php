    ...
    <div class="main-content">
        ...
        <div class="tabla"> 
            <table>
                ...
                $offset=$limit-5;
                $consulta="SELECT * from ano_escolar LIMIT $offset,$limit";
                $resultado=mysqli_query($conexion, $consulta);

                $paginas="SELECT * from ano_escolar";
                ...
                <tr>
    			    <td class="limitado1"><?php echo $mostrar["nombre"]?></td>
    			    <td class="limitado2"><?php echo $mostrar["fecha_inicio"]?></td>
                    <td class="limitado2"><?php echo $mostrar["fecha_fin"]?></td>
                    <td class="no_style">
                        <button onclick='Eliminar(`<?php echo $mostrar["nombre"]; ?>`)' class='table_button'>Eliminar</button>
                        <button onclick='Modificar(`<?php echo $mostrar["nombre"]; ?>`,`<?php echo $mostrar["fecha_inicio"];?>`,`<?php echo $mostrar["fecha_fin"];?>`)' class='table_button'>Modificar</button>
                    </td>
    			</tr>
