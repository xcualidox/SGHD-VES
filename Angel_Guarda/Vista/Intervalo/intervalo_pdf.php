...
$pdf->Cell(40, 10, "");
$pdf->SetX(($pdf->GetPageWidth() - $pdf->GetStringWidth("INTERVALO")) / 2);
$pdf->Cell(120, 10, "INTERVALO");
$pdf->Ln();
$pdf->SetFont('Arial', '', 14);
$pdf->Cell(40, 10, "");
$pdf->Cell(40, 10, "INTERVALO", "LTRB");
$pdf->Cell(40, 10, "ESTADO", "LTRB");
$pdf->Ln();
$pdf->SetFont('Arial', '', 12);
// Agrega los datos de la tabla al archivo PDF
while($row = mysqli_fetch_assoc($result)) {
    $pdf->Cell(40, 10, "");
  $pdf->Cell(40, 10, $row["intervalo"], "LTRB");
  if ($row["estado"]==0) {
