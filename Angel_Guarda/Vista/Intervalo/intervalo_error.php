...
<body>
    ...
    <div class="main-content">
        ...
        <div class="error">
            <p>El dato introducido ya se encuentra en nuestra base de datos</p>
        </div>
        ...
        <table>
            ...
            $offset=$limit-5;
            $consulta="SELECT * from intervalo LIMIT $offset,$limit";
            $resultado=mysqli_query($conexion, $consulta);

            $paginas="SELECT * from intervalo";
            ...
            <tr>
    			<td class="limitado1" style='text-align:center;'><?php echo $mostrar["intervalo"]?></td>
                <td class="no_style">
                    <button onclick='Eliminar(`<?php echo $mostrar["intervalo"]; ?>`)' class='table_button'>Eliminar</button>
                    <button onclick='Modificar(`<?php echo $mostrar["intervalo"]; ?>`,`<?php echo $mostrar["estado"];?>`)' class='table_button'>Modificar</button>
                    <?php 
                    if ($mostrar["estado"]==1) {
                        echo "<button type='button' class='desactivar' onclick='Disponibilidad(`Desactivar`,`".$mostrar["id"]."`)'>Desactivar</button>";
                    }
                    else {
                        echo "<button type='button' class='activar' onclick='Disponibilidad(`Activar`,`".$mostrar["id"]."`)'>Activar</button>";
                    }
                    ?>
                </td>
    		</tr>
