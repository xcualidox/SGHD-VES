        ...
        <div class=" w-full">
            ...
            <div class="formulario-extenso__row">
                <div class="formulario-extenso__column">
                    ...
                    <input type="radio" id="efectivo" value="divisas" name="tipoPago">Divisas
                    <input type="radio" id="" name="tipoPago">Transferencia
                </div>
            ...
            <div class="formulario-extenso__row">
                ...
                <div class="formulario-extenso__column">
                    ...
                    <input type="text" id="mesPagar" name="mesPagar" placeholder="Monto a Pagar" class="formulario-extenso__input" maxlength="25">
                </div>
                </div>
            </div>
        </div>
