    ...
    <div class="main-content">
        ...
        <div class="tabla"> 
            <table>
                ...
                $offset=$limit-5;
                $consulta="SELECT `cedula`,`nombre`,`apellido`,`rol` from usuarios  WHERE `cedula`<>'2023' LIMIT $offset,$limit";
                $resultado=mysqli_query($conexion, $consulta);

                $paginas="SELECT `cedula`,`nombre`,`apellido`,`rol` from usuarios WHERE `cedula`<>'2023'";
