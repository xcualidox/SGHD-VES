...
<div class="sidebar">
    ...
    <div class="main-content">
        ...
        <table>
            ...
            $offset=$limit-5;
            $consulta="SELECT * from aula LIMIT $offset,$limit";
            $resultado=mysqli_query($conexion, $consulta);

            $paginas="SELECT * from aula";
            ...
            <tr>
                ...
                <td class="limitado2"><?php echo $mostrar["descripcion"]?></td>
                <td class="no_style">
                    <button onclick='Eliminar(`<?php echo $mostrar["nombre"]; ?>`)' class='table_button'>Eliminar</button>
                    <button onclick='Modificar(`<?php echo $mostrar["nombre"]; ?>`,`<?php echo $mostrar["descripcion"];?>`)' class='table_button'>Modificar</button>
                </td>
    		</tr>
        ...
        <div class="formulario">
            <form id="form" style="display: none;" name="pantalla" class='pantalla' method="POST" action="../../Control/aula.php">
                ...
                <input type="text" id="nom" name="nom" placeholder="Nombre del aula" class="formulario__input"> 
