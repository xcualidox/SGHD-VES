    ...
    <div class="main-content">
        ...
        <div class="tabla"> 
            <table>
                ...
                $offset=$limit-5;
                $consulta="SELECT * from asignatura LIMIT $offset,$limit";
                $resultado=mysqli_query($conexion, $consulta);

                $paginas="SELECT * from asignatura";
                ...
                <tr>
    			    <td class="limitado1"><?php echo $mostrar["codigo"]?></td>
    			    <td class="limitado2"><?php echo $mostrar["nombre"]?></td>
                    <td class="no_style">
                        <button onclick='Eliminar(`<?php echo $mostrar["codigo"]; ?>`)' class='table_button'>Eliminar</button>
                        <button onclick='Modificar(`<?php echo $mostrar["codigo"]; ?>`,`<?php echo $mostrar["nombre"];?>`)' class='table_button'>Modificar</button>
                    </td>
    			</tr>
