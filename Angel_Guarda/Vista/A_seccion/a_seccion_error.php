    ...
    <div class="main-content">
        ...
        <div class="tabla"> 
            <table>
                ...
                $offset=$limit-5;
                $consulta="SELECT * from ano_seccion LIMIT $offset,$limit";
                $resultado=mysqli_query($conexion, $consulta);

                $paginas="SELECT * from ano_seccion";
                ...
                <tr>
    			    <td class="limitado1"><?php echo $mostrar["ano"]?></td>
    			    <td class="limitado2"><?php echo $mostrar["seccion"]?></td>
                    <td class="no_style">
                        <button onclick='Eliminar(`<?php echo $mostrar["ano"]; ?>`,`<?php echo $mostrar["seccion"];?>`)' class='table_button'>Eliminar</button>
                        <button onclick='Modificar(`<?php echo $mostrar["ano"]; ?>`,`<?php echo $mostrar["seccion"];?>`)' class='table_button'>Modificar</button>
                    </td>
    			</tr>
