...
-- Tiempo de generación: 01-11-2025 a las 20:41:06
...
CREATE TABLE `representante` (
  ...
  `ocupacion` varchar(150) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `parentesco` varchar(100) COLLATE utf8mb3_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
...
--
ALTER TABLE `pagos`
  MODIFY `idPago` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
